...
export default function FormAdvancedPage() {
  return (
    <>
      <Seo title="Form Advanced (Disabled)" />
      <Pageheader
        title="Forms"
      ...
      <div className="p-4">
        <h3 className="mb-2">Form Advanced (Demo Disabled)</h3>
        <p className="mb-0">
          यह theme का demo page है, Baby Shield project में इसका use नहीं है,
          इसलिए इसे simple placeholder रखा गया है ताकि build clean रहे।
        </p>
      </div>
    </>
  );
